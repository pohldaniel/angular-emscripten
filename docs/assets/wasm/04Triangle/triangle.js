...
["_WAFNDraw","_memory","___indirect_function_table","_main","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  function _WAJS_GetTime() {
           return Date.now() - this.initTime; 
      }

  function _WAJS_SetupCanvas(width, height) {
...
var wasmImports = {
  /** @export */
  WAJS_GetTime: _WAJS_GetTime,
  /** @export */
  WAJS_SetupCanvas: _WAJS_SetupCanvas,
  /** @export */
...
var _WAFNDraw = Module['_WAFNDraw'] = createExportWrapper('WAFNDraw', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = TriangleModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = TriangleModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => TriangleModule);
