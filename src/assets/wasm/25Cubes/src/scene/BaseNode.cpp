...
void BaseNode::setScale(const glm::vec3& scale) const {
...
void BaseNode::setPosition(const glm::vec3& position) const {
	Object::setPosition(position);
	OnTransformChanged();	
}

void BaseNode::setOrientation(const glm::vec3& axis, float degrees) const {
...
void BaseNode::setOrientation(const glm::vec3& euler) const {
	Object::setOrientation(euler);
	OnTransformChanged();
}

void BaseNode::setOrientation(const glm::quat& orientation) const {
...
void BaseNode::translate(const glm::vec3& trans) {
...
void BaseNode::translateRelative(const glm::vec3& trans) {
...
void BaseNode::scale(const glm::vec3& scale) {
	Object::scale(scale);
	OnTransformChanged();
}
...
void BaseNode::rotate(const glm::vec3& eulerAngle) {
	Object::rotate(eulerAngle);
	OnTransformChanged();
}

void BaseNode::rotate(const glm::vec3& axis, float degrees) {
	Object::rotate(axis, degrees);
	OnTransformChanged();
}

void BaseNode::rotate(const glm::quat& orientation) {
