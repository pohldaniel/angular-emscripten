emcc^
 ...
 -I "./" -I "./include" -I "./include/animation" -I "./include/scene/" -I "./libimgui" -I "../include/glm" -I "../include/FreeImage" -I "../include/rapidjson/include" -I "../include" -I "../include/bullet"^
