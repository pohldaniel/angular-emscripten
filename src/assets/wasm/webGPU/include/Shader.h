...
public:
	...
	void use() const;
	void unuse() const;
	void loadMatrix(const char* location, const glm::mat4& matrix, bool trans = false) const;
	void loadMatrix(const char* location, const float matrix[16], bool trans = false) const;
	void loadMatrixArray(const char* location, const std::vector<glm::mat4> matrixArray, const unsigned short count, bool trans = false) const;

	void loadVector(const char* location, glm::vec4 vector) const;
	void loadVector(const char* location, glm::vec3 vector) const;
	void loadVector(const char* location, glm::vec2 vector) const;
