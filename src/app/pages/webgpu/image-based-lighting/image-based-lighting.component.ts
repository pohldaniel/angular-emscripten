...
@Component({
  selector: 'app-image-based-lighting',
  templateUrl: './image-based-lighting.component.html',
  styleUrls: ['./image-based-lighting.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class ImageBasedLightingComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("IBLModule",  'assets/wasm/12ImageBasedLighting/webgpu.js', 'assets/wasm/12ImageBasedLighting/webgpu.wasm', 'assets/wasm/12ImageBasedLighting/webgpu.data');
  }
