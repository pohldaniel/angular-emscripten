...
@Component({
  selector: 'app-audio-decode',
  templateUrl: './audio-decode.component.html',
  styleUrls: ['./audio-decode.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class AudioDecodeComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("AudioDecodeModule",  'assets/wasm/23AudioDecode/webgpu.js', 'assets/wasm/23AudioDecode/webgpu.wasm', 'assets/wasm/23AudioDecode/webgpu.data');
  }
