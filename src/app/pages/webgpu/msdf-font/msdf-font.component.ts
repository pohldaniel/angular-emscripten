...
@Component({
  selector: 'app-msdf-font',
  templateUrl: './msdf-font.component.html',
  styleUrls: ['./msdf-font.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class MSDFFontComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("MSDFFontModule",  'assets/wasm/10MSDFFont/webgpu.js', 'assets/wasm/10MSDFFont/webgpu.wasm', 'assets/wasm/10MSDFFont/webgpu.data');
  }
