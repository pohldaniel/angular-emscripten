...
@Component({
  selector: 'app-nuklear-gui',
  templateUrl: './nuklear-gui.component.html',
  styleUrls: ['./nuklear-gui.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class NuklearGuiComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
