...
@Component({
  selector: 'app-render-bundles',
  templateUrl: './render-bundles.component.html',
  styleUrls: ['./render-bundles.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class RenderBundlesComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
