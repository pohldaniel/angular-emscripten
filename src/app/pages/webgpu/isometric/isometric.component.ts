...
@Component({
  ...
  styleUrls: ['./isometric.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class IsometricComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("IsometricModule",  'assets/wasm/24Isometric/webgpu.js', 'assets/wasm/24Isometric/webgpu.wasm', 'assets/wasm/24Isometric/webgpu.data');
  }
