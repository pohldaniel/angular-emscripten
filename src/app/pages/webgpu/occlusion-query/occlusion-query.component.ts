...
@Component({
  selector: 'app-occlusion-query',
  templateUrl: './occlusion-query.component.html',
  styleUrls: ['./occlusion-query.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class OcclusionQueryComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("OcclusionQueryModule",  'assets/wasm/20OcclusionQuery/webgpu.js', 'assets/wasm/20OcclusionQuery/webgpu.wasm', 'assets/wasm/20OcclusionQuery/webgpu.data');
  }
