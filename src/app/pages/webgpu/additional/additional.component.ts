...
export class AdditionalComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('canvas') canvas!: ElementRef;
  @ViewChild('span') span!: ElementRef;
  error!: string;

  constructor(private ngZone: NgZone) {
    super("AdditionalModule",  'assets/wasm/06Additional/webgpu.js', 'assets/wasm/06Additional/webgpu.wasm', 'assets/wasm/06Additional/webgpu.data');
  }
