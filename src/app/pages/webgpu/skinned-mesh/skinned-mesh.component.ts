...
@Component({
  selector: 'app-skinned-mesh',
  templateUrl: './skinned-mesh.component.html',
  styleUrls: ['./skinned-mesh.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class SkinnedMeshComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("SkinnedMeshModule",  'assets/wasm/14SkinnedMesh/webgpu.js', 'assets/wasm/14SkinnedMesh/webgpu.wasm', 'assets/wasm/14SkinnedMesh/webgpu.data');
  }
