...
@Component({
  selector: 'app-compute-particle-logo',
  templateUrl: './compute-particle-logo.component.html',
  styleUrls: ['./compute-particle-logo.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class ComputeParticleLogoComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("ComputeParticleLogoModule",  'assets/wasm/15ComputeParticleLogo/webgpu.js', 'assets/wasm/15ComputeParticleLogo/webgpu.wasm', 'assets/wasm/15ComputeParticleLogo/webgpu.data');
  }
