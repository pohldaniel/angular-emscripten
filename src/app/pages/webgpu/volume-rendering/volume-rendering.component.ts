...
@Component({
  selector: 'app-volume-rendering',
  templateUrl: './volume-rendering.component.html',
  styleUrls: ['./volume-rendering.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class VolumeRenderingComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("VolumeRenderingModule",  'assets/wasm/19VolumeRendering/webgpu.js', 'assets/wasm/19VolumeRendering/webgpu.wasm', 'assets/wasm/19VolumeRendering/webgpu.data');
  }
