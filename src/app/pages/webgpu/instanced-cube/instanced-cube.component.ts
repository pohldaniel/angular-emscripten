...
@Component({
  selector: 'app-instanced-cube',
  templateUrl: './instanced-cube.component.html',
  styleUrls: ['./instanced-cube.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class InstancedCubeComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("InstancedCubeModule",  'assets/wasm/11InstancedCube/webgpu.js', 'assets/wasm/11InstancedCube/webgpu.wasm', 'assets/wasm/11InstancedCube/webgpu.data');
  }
