...
@Component({
  selector: 'app-stencil-mask',
  templateUrl: './stencil-mask.component.html',
  styleUrls: ['./stencil-mask.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class StencilMaskComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("StencilMaskModule",  'assets/wasm/17StencilMask/webgpu.js', 'assets/wasm/17StencilMask/webgpu.wasm', 'assets/wasm/17StencilMask/webgpu.data');
  }
