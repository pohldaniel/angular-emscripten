...
@Component({
  selector: 'app-primitive-picking',
  templateUrl: './primitive-picking.component.html',
  styleUrls: ['./primitive-picking.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class PrimitivePickingComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("PrimitivePickingModule",  'assets/wasm/16PrimitivePicking/webgpu.js', 'assets/wasm/16PrimitivePicking/webgpu.wasm', 'assets/wasm/16PrimitivePicking/webgpu.data');
  }
