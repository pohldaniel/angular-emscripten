...
@Component({
  ...
  styleUrls: ['./shadow-mapping.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class ShadowMappingComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("ShadowMappingModule",  'assets/wasm/13ShadowMapping/webgpu.js', 'assets/wasm/13ShadowMapping/webgpu.wasm', 'assets/wasm/13ShadowMapping/webgpu.data');
  }
