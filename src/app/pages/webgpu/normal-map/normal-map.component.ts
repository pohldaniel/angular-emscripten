...
@Component({
  ...
  styleUrls: ['./normal-map.component.sass'],
  imports: [ResizedDirective, SpinnerComponent, NgStyle],
  standalone: true,
})
export class NormalMapComponent extends EmscriptenWasmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private ngZone: NgZone, private renderer: Renderer2) {
    super("NormalMapModule",  'assets/wasm/09NormalMap/webgpu.js', 'assets/wasm/09NormalMap/webgpu.wasm', 'assets/wasm/09NormalMap/webgpu.data');
  }
